...
constexpr const char* BLUE_1 = "#c8d6e5";  // 主文字色 (浅蓝灰)
constexpr const char* BLUE_2 = "#5b9cf5";  // Highlight 按钮常态
constexpr const char* BLUE_3 = "#1a3a6b";  // 标题栏背景
constexpr const char* BLUE_4 = "#3a7de0";  // IconButton Color 常态
constexpr const char* BLUE_5 = "#2a5a9e";  // IconButton Color 悬停/Bg0
constexpr const char* BLUE_6 = "#152238";  // 右侧资讯面板
constexpr const char* BLUE_7 = "#1a2d4a";  // Button 悬停背景
constexpr const char* BLUE_8 = "#131d2e";  // 左侧边栏背景

// ── 背景色 ────────────────────────────────────────────────────────────────

constexpr const char* BG_MAIN         = "#1a1f2e";  // 主背景
...
// ============================================================================
// 主题切换辅助 — 根据 ThemeBrightness 选择对应色板
// ============================================================================

/** 根据主题亮度返回对应颜色命名空间中的常量值。
 *  用于 Styles.cpp 中构建 CSS 时查找颜色:
 *
 *    auto c = theme_color<&BLUE_1, &dark::BLUE_1>(brightness);
 */
